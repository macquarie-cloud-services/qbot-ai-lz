...
output "webapp_nodejs_principal_id" {
  ...
  value       = var.enable_webapp_nodejs ? module.webapp_nodejs[0].system_assigned_mi_principal_id : null
}
...
output "webapp_nodejs_default_hostname" {
  ...
  value       = var.enable_webapp_nodejs ? module.webapp_nodejs[0].resource_uri : null
}
...
output "webapi_dotnet_principal_id" {
  ...
  value       = var.enable_webapi_dotnet ? module.webapi_dotnet[0].system_assigned_mi_principal_id : null
}

output "webapi_dotnet_default_hostname" {
  description = "Default hostname of the .NET WebAPI. Null when enable_webapi_dotnet = false."
  value       = var.enable_webapi_dotnet ? module.webapi_dotnet[0].resource_uri : null
}
...
output "memory_pipeline_principal_id" {
  ...
  value       = var.enable_memory_pipeline ? module.memory_pipeline_dotnet[0].system_assigned_mi_principal_id : null
}
...
output "function_app_principal_id" {
  ...
  value       = var.enable_function_app ? module.function_app[0].system_assigned_mi_principal_id : null
}

output "function_app_default_hostname" {
  description = "Default hostname of the Function App. Null when enable_function_app = false."
  value       = var.enable_function_app ? module.function_app[0].resource_uri : null
}
